        ...
        return (
            <div>
                <div className=" bg-green-400">
                    <div className="flex flex-col items-center p-4 border-slate-400 border-2 shadow-lg">
                        <h1 className="md:text-4xl ">Frontend Skills:</h1>
                        <div>
                            <ol>
                                <li>React</li>
                                <li>HTML5</li>
                ...
                <div className=" bg-green-400">
                    <div className="flex flex-col items-center p-4 border-slate-400 border-2 shadow-lg mt-4">
                        <h1 className="md:text-4xl ">Backend Skills:</h1>
                        <div>
                            <ol>
                                <li>NodeJS</li>
                                <li>ExpressJS</li>
        ...
        <div className="">
            ...
            <div className="flex flex-col  text-2xl mx-10">
                ...
                <div className="mt-4 flex flex-col md:flex-row">
                    ...
                    <div id="technologies" className="animate hidden w-full ">  {technologiesText()} </div>
